          ...
          {pages.map((page) => {
            return (
              <Link href={page.link} key={page.name}>
                <a className="  text-hero_section_text text-xl font-primary py-2 px-4 hover:rounded-full hover:text-white hover:bg-primary transition-all duration-200 mx-2 lg:my-8  active:bg-primary active:text-white active:rounded-full">
                  {page.name}
                </a>
              </Link>
            );

     ...
     return (
            <section className='flex flex-col my-24 mt-14 mx-14 sm:mx-6'>
             ...
             <div className='flex flex-col gap-10'> 
              <div className='flex flex-wrap items-center justify-center m-auto gap-20 gap-y-40 mt-12 sm:gap-y-30 sm:mb-24'>
                    {
                     team.map((teamMember)=>{
                     if(teamMember.role == 'Advisor' ||  teamMember.role == 'Lead Organiser' || teamMember.role == 'Co-Lead Organiser'){
                         return (
